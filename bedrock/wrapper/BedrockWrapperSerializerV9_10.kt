...
class BedrockWrapperSerializerV9_10 private constructor(zlib: Zlib) : BedrockWrapperSerializer() {
    private val zlib: Zlib
        ...
        try {
            for (packet in packets) {
                ...
                try {
                    ...
                    var header = 0
                    header = header or (id and 0x3ff)
                    header = header or (packet.senderId and 3 shl 10)
                    header = header or (packet.clientId and 3 shl 12)
                    ...
                    BedrockWrapperSerializer.Companion.log.debug(
        ...
        try {
            ...
            while (decompressed.isReadable) {
                ...
                try {
                    ...
                    packet.senderId = header ushr 10 and 3
                    packet.clientId = header ushr 12 and 3
                    packets.add(packet)
                } catch (e: PacketSerializeException) {
    ...
    companion object {
        val V9 = BedrockWrapperSerializerV9_10(Zlib.DEFAULT)
        val V10 = BedrockWrapperSerializerV9_10(Zlib.RAW)
    }
